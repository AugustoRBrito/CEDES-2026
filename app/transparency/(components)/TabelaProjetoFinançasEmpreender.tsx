...
const dadosFallback: ProjetoData = {
  ...
  periodoExecucao: 'Data da assinatura do Termo de Fomento: 17/12/2025 — Prazo de execução: 6 meses',
  valorGlobal: {
    valor:
  ...
  situacaoPrestacaoContas: 'Termo de Fomento nº 975923/2025 em execução',
